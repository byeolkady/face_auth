...
app.get('/register_id', (req, res) => res.sendFile(path.join(viewsDir, 'register_id.html')))
app.get('/detect_id', (req, res) => res.sendFile(path.join(viewsDir, 'detect_id.html')))
app.get('/face_auth', (req, res) => res.sendFile(path.join(viewsDir, 'bbtFaceSimilarity.html')))
...
app.listen(15025, () => console.log('Listening on port 15025!'))
